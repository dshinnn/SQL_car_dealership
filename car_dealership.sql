...
insert into salesperson (first_name, last_name, phone_number, email) values ('David', 'Shin', '888-111-2312', 'sd@sales.com');
insert into salesperson (first_name, last_name, phone_number, email) values ('Bob', 'Smith', '888-234-1231', 'bs@sales.com');

-- Insert into mechanic
insert into mechanic (first_name, last_name, email, address, phone_number) values ('Tommy', 'Jones', 'TJ@sales.com', '333 Mechanic St.', '888-123-4567');
insert into mechanic (first_name, last_name, email, address, phone_number) values ('Robert', 'Jones', 'RJ@dt.com', '334 Mechanic St.', '888-890-1011');

-- Insert into car
insert into car(make, model, car_year, color, is_new, car_payment_amount, seller_id) values ('honda', 'civic', '2020', 'white', true, 20000, 1);
insert into car(make, model, car_year, color, is_new, car_payment_amount) values ('acura', 'rl', '2016', 'black', false, 15000);
...
call add_customer('Bobby', 'Hill', '999-555-1231', 'koh@fox.com', '123 Street st.');
call add_customer('Hank', 'Hill', '999-555-5431', 'koh@fox.com', '123 Street st.', 1);
